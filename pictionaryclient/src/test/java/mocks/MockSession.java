...
public class MockSession implements Session {
    private MockRemoteEndPoint mockRemoteEndPoint;

    public MockSession(MockRemoteEndPoint mockRemoteEndPoint){
        this.mockRemoteEndPoint = mockRemoteEndPoint;
    }

    public MockRemoteEndPoint getMockRemoteEndPoint() {
